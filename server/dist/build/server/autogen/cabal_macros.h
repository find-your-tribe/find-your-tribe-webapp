...
/* package find-your-tribe-0.0.0 */
#ifndef VERSION_find_your_tribe
#define VERSION_find_your_tribe "0.0.0"
#endif /* VERSION_find_your_tribe */
#ifndef MIN_VERSION_find_your_tribe
#define MIN_VERSION_find_your_tribe(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_find_your_tribe */
...
#define CURRENT_COMPONENT_ID "find-your-tribe-0.0.0-JGeHZergeQe7T4IUHkMNsS-server"
